...
root_dir = "/home/admin00/HYD/dataset/NUS-WIDE"
...
imagePath = os.path.join("/home/admin00/HYD/dataset/nuswide/Flickr")
...
with open("/home/admin00/HYD/dataset/NUS-WIDE/Groundtruth/used_label.txt", encoding='utf-8') as f:
...
not_used_id = []
with open("/home/admin00/HYD/dataset/NUS-WIDE/Groundtruth/not_used_id.txt", encoding='utf-8') as f:
...
scio.savemat('/home/admin00/HYD/DCHMT-main/dataset/nuswide/index.mat', indexs)
# scio.savemat("caption.mat", captions)
scio.savemat('/home/admin00/HYD/DCHMT-main/dataset/nuswide/label.mat', labels)


captions = [item + "\n" for item in captions["caption"]]

with open('/home/admin00/HYD/DCHMT-main/dataset/nuswide/caption.txt', "w", encoding='utf-8') as f:
